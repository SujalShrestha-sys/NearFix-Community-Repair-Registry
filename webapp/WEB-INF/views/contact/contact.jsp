<%-- ============================================================ Page: Contact
Us (contact.jsp) Route: GET /contact Servlet: ContactServlet.java Description:
The main Contact Us page. Assembles components.
============================================================ --%> <%@ page
...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Get in touch with the NearFix team. We're here to help with your repair needs or answer any questions about our platform."
    />
