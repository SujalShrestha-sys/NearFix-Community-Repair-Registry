...
<aside class="w-[260px] min-w-[260px] bg-white flex flex-col p-0 border-r border-border fixed top-0 left-0 bottom-0 z-20 transform -translate-x-full lg:translate-x-0 transition-transform duration-300 ease-in-out">
    ...
    <a class="flex items-center gap-3 py-2.5 px-3.5 mx-2.5 my-px rounded-[10px] text-sm font-medium ${requestScope['jakarta.servlet.forward.servlet_path'] == '/user/my-requests' ? 'text-primary bg-primary-light' : 'text-nav hover:bg-primary-hover'} no-underline relative transition-colors" href="${pageContext.request.contextPath}/user/my-requests">
        <svg class="w-[18px] h-[18px] shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a class="flex items-center gap-3 py-2.5 px-3.5 mx-2.5 my-px rounded-[10px] text-sm font-medium ${requestScope['jakarta.servlet.forward.servlet_path'] == '/user/post-request' ? 'text-primary bg-primary-light' : 'text-nav hover:bg-primary-hover'} no-underline relative transition-colors" href="${pageContext.request.contextPath}/user/post-request">
        <svg class="w-[18px] h-[18px] shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a class="flex items-center gap-3 py-2.5 px-3.5 mx-2.5 my-px rounded-[10px] text-sm font-medium ${requestScope['jakarta.servlet.forward.servlet_path'] == '/repairers' ? 'text-primary bg-primary-light' : 'text-nav hover:bg-primary-hover'} no-underline relative transition-colors" href="${pageContext.request.contextPath}/repairers">
        <svg class="w-[18px] h-[18px] shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <a class="flex items-center gap-3 py-2.5 px-3.5 mx-2.5 my-px rounded-[10px] text-sm font-medium ${requestScope['jakarta.servlet.forward.servlet_path'] == '/user/profile' ? 'text-primary bg-primary-light' : 'text-nav hover:bg-primary-hover'} no-underline relative transition-colors" href="${pageContext.request.contextPath}/user/profile">
        <svg class="w-[18px] h-[18px] shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
