...
<!-- STATS CARDS -->
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[18px] mb-[22px]">
    <!-- Total Jobs -->
    ...
    <!-- Active Now -->
    <div class="bg-white rounded-[20px] pt-[22px] pr-[22px] pb-5 pl-[22px] border border-border shadow-stat flex flex-col gap-1 relative min-h-[108px]">
        <span class="text-[10px] font-semibold tracking-[0.07em] uppercase text-muted">Active Now</span>
        <span class="text-[42px] font-extrabold text-dark leading-[1.05] tracking-[-1.5px] mt-[2px]">${activeJobs.size()}</span>
        <span class="text-xs text-muted font-normal mt-px">In progress</span>
        <div class="absolute top-5 right-5 w-10 h-10 rounded-[12px] flex items-center justify-center bg-yellow-light">
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="#F4B63D" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <!-- Rating -->
    <div class="bg-white rounded-[20px] pt-[22px] pr-[22px] pb-5 pl-[22px] border border-border shadow-stat flex flex-col gap-1 relative min-h-[108px]">
        <span class="text-[10px] font-semibold tracking-[0.07em] uppercase text-muted">Rating</span>
        <span class="text-[42px] font-extrabold text-dark leading-[1.05] tracking-[-1.5px] mt-[2px]">${repairer.rating > 0 ? repairer.rating : '0.0'}</span>
        <span class="text-xs text-muted font-normal mt-px">Customer reviews</span>
        <div class="absolute top-5 right-5 w-10 h-10 rounded-[12px] flex items-center justify-center bg-yellow-light">
            <svg class="w-5 h-5" viewBox="0 0 24 24" fill="#F4B63D" stroke="#F4B63D" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
